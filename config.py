...
KEY_BOT_TOKEN = os.getenv("KEY_BOT_TOKEN", "8661876027:AAE57o1PoSOMZ-HTHvGMYaDmeWoy9kvXl38")
UPLOADER_BOT_TOKEN = os.getenv("UPLOADER_BOT_TOKEN", "8797731102:AAEag992dyrf-MXMDZohpDw29gB7PwuQYRs")
